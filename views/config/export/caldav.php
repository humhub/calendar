...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <div class="text-right help-block">
            <div id="url_1" class="hidden"><?= Url::to(['/calendar/remote/cal-dav'], true) ?></div>
    ...
    <div class="form-group">
        ...
        <div class="text-right help-block">
            <div id="url_1" class="hidden"><?= Url::to(['/'], true) ?></div>
            <?= Link::withAction(Yii::t('CalendarModule.export', 'Copy to clipboard'), 'copyToClipboard', null, '#url_1')->icon('fa-clipboard')->style('color:#777') ?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="text-right help-block">
            <div id="url_1" class="hidden"><?= Yii::$app->user->identity->username ?></div>
            <?= Link::withAction(Yii::t('CalendarModule.export', 'Copy to clipboard'), 'copyToClipboard', null, '#url_1')->icon('fa-clipboard')->style('color:#777') ?>
        </div>
    </div>
    <div class="form-group">
