...
return [
    ...
    'Here you can configure global default reminders. These settings can be overwritten on space/profile level.' => 'ここでグローバルなデフォルト リマインダーを設定できます。これらの設定はスペース/プロフィール レベルで上書きできます。',
    'Hour' => '時',
    'I\'m attending' => '参加する',
    'ID' => 'ID',
