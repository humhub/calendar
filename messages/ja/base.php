...
return [
  ...
  'Deleted' => '削除しました',
  'Description' => '説明',
  'Display events within the next X days' => '今後X日間のイベントを表示',
  ...
  'Friday' => '金曜',
  'From Newest to Oldest' => '新しいものから古いものへ',
  'From Oldest to Newest' => '古いものから新しいものへ',
  ...
  'Leave empty to list all events. Enter 0 to display only today\'s events.' => 'すべてのイベントを表示するには、何も入力しないでください。今日のイベントのみを表示するには0を入力してください。',
  'List' => 'リスト',
  'Location' => '場所',
  ...
  'Repeat every' => '繰り返す間隔',
  'Saturday' => '土曜',
  'Select calendar event' => 'カレンダーイベントを選択',
  ...
  'This field only allows a maximum 1 calendar entry.' => 'このフィールドには最大1つのカレンダーしか入力できません。',
  'Thursday' => '木曜',
  'Time Zone' => 'タイムゾーン',
  'Title' => 'タイトル',
  'Today' => '今日',
