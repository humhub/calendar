...
return array (
  ...
  '{displayName} just added you to event "{contentTitle}".' => '{displayName} te ha agregado al evento "{contentTitle}".',
  '{displayName} just invited you to event "{contentTitle}".' => '{displayName} acaba de invitarte al evento "{contentTitle}".',
