...
return [
    ...
    '{displayName} reopened event "{contentTitle}" in space {spaceName}.' => '{displayName} ponovno je pokrenuo događaj "{contentTitle}" u prostoru {spaceName}.',
    '{displayName} reopened event "{contentTitle}".' => '{displayName} ponovo je porenuo događaj "{contentTitle}".',
];
