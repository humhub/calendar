...
return [
    ...
    '{displayName} just added you to event "{contentTitle}" in space {spaceName} starting at {time}.' => '{displayName} vas je upravo dodao na događaj "{contentTitle}" u prostoru {spaceName} koji počinje {time}.',
