...
return [
  ...
  'Friday' => 'Sexta-feira',
  'From Newest to Oldest' => 'Do mais novo ao mais antigo',
  'From Oldest to Newest' => 'Do mais antigo ao mais novo',
  ...
  'Here you can configure the default reminder settings for this event. Users are able to overwrite these settings by means of the
    <strong>Set reminder</strong> link.' => 'Aqui você pode configurar as configurações de lembrete padrão para este evento. Os usuários podem substituir essas configurações por meio do link <strong>Definir lembrete</strong>.',
  'Hour' => 'Hora',
  ...
  'Include Organizer and Participant Info in Exports' => 'Incluir informações do organizador e do participante nas exportações',
  ...
  'Week' => 'Semana',
  'Weeks' => 'Semanas',
  'When enabled, calendar exports (ics, iCal, CalDAV) will include the organizer\'s and participant\'s names and email addresses. Disable to exclude this information for increased privacy.' => 'Quando ativada, a exportação de calendários (ics, iCal, CalDAV) incluirá os nomes e endereços de e-mail do organizador e dos participantes. Desative para excluir essas informações e aumentar a privacidade.',
  'Year' => 'Ano',
  'Years' => 'Anos',
