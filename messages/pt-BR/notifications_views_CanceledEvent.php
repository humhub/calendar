...
return array (
  ...
  '{displayName} just added you to event "{contentTitle}".' => '{displayName} acabou de adicionar você ao evento "{contentTitle}".',
  '{displayName} just invited you to event "{contentTitle}".' => '{displayName} acaba de convidar você para o evento "{contentTitle}".',
  ...
  '{displayName} just updated event {contentTitle}.' => '{displayName} acabou de atualizar o evento {contentTitle}.',
