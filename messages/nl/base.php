...
return array (
  ...
  '{displayName} just invited you to event "{contentTitle}" in space {spaceName} starting at {time}.' => '{displayName} heeft u uitgenodigd voor evenement "{contentTitle}" in ruimte {spaceName} dat begint om {time}.',
);
