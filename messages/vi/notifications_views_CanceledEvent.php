...
return [
    '{displayName} canceled event "{contentTitle}" in space {spaceName}.' => '{displayName} đã hủy sự kiện "{contentTitle}" trong diễn đàn {spaceName}.',
    ...
    '{displayName} just updated event "{contentTitle}" in space {spaceName}.' => '{displayName} vừa mới cập nhật "{contentTitle}" trong diễn đàn {spaceName}.',
