...
return [
    ...
    '{displayName} just added you to event "{contentTitle}".' => '{displayName} La deg til et arrangement "{contentTitle}".',
    ...
    '{displayName} just updated event {contentTitle}.' => '{displayName} oppdaterte arrangementet {contentTitle}.',
