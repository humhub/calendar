...
class CalendarReminder extends ActiveRecord
{
     ...
     * @return []
     */
    public static function getEntryLevelReminder(ContentActiveRecord $model)
    {
        return static::find()
            ->where(['object_id' => $model->id, 'object_model' => get_class($model)])
            // We want user entry level first with given contentcontainer_id
